...
export const AnimatedBorderButton = memo(({ children, ...props }) => {
  return (
    <button
      {...props}
      className="relative bg-transparent border border-border 
        ...
        px-4 md:px-8 py-4 md:py-4 text-sm md:text-lg font-medium rounded-full overflow-visible 
        animated-border gpu-accelerated"
    ...
    >
      ...
      >
        <path
          ...
          className="animated-border-path absolute"
        />
      </svg>
